...
void main() {
  ...
  vec3 stretchedVertPosition = vec3(vertPosition.x, vertPosition.y, vertPosition.z * 5);
  float val1 = snoise(stretchedVertPosition * 0.05);
  float val2 = snoise(stretchedVertPosition * 0.1);
  float val3 = snoise(stretchedVertPosition * 0.2);
  float val4 = snoise(stretchedVertPosition * 0.4);
  float val5 = snoise(stretchedVertPosition * 0.8);
